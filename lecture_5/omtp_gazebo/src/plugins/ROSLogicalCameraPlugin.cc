...
#include "omtp_gazebo/plugins/ROSLogicalCameraPlugin.hh"

#include "omtp_gazebo/plugins/ARIAC.hh"
#include "omtp_gazebo/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<omtp_gazebo::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
    ...
    omtp_gazebo::LogicalCameraImage imageMsg;
