 ...
 *
*/
#include "omtp_gazebo/plugins/ROSConveyorBeltPlugin.hh"
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  omtp_gazebo::ConveyorBeltControl::Request, omtp_gazebo::ConveyorBeltControl::Response> & event)
{
  const omtp_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  omtp_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
