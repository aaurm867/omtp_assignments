...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "omtp_gazebo/plugins/ROSVacuumGripperPlugin.hh"
#include "omtp_gazebo/VacuumGripperControl.h"
#include "omtp_gazebo/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    omtp_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  omtp_gazebo::VacuumGripperControl::Request &_req,
  omtp_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  omtp_gazebo::VacuumGripperState msg;
