#include <ros/ros.h>
#include "omtp_gazebo/urdf_creator.h"
...
int main(int argc, char **argv)
{
  ...
  pnh.param<std::string>("mesh_resource", mesh_resource, "package://omtp_gazebo/meshes/conveyor_objects/gear.stl");
  ...
  std::string parsed_xml = omtp::simulation::createObjectURDF("gear", mesh_resource);
  ...
  srv.request.robot_namespace = "omtp";
